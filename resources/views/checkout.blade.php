				...
				<div class="row"> 
					<div class="col-lg-8 col-12">
						<div class="checkout-form">
							...
							<p>Please enter the following inorder to checkout</p>
							<!-- Form -->
							<form class="form" method="post" action="#">
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>Detailed Shipping Address<span>*</span></label>
							...
							<div class="single-widget">
								...
								<div class="content">
									<div class="checkbox">
										...
										<label class="checkbox-inline" for="3"><input name="news" id="3" type="checkbox"> Mobile Banking</label>
									</div>
								</div>
							</div>
							<!--/ End Order Widget -->
